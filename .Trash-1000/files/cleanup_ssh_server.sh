...
echo "🧹 ZION SSH Server Complete Cleanup"
echo "====================================="
echo "Server: $SERVER"
echo "⚠️  WARNING: This will DELETE ALL ZION data on server!"
echo ""

# Ask for confirmation
read -p "Are you sure you want to completely clean the SSH server? (yes/no): " confirm
if [[ $confirm != "yes" ]]; then
